...
export class MenuListComponent implements OnInit {
  ...
  UContents = ['tÜyelik Işlemleri', 'yÜyeler', 'nİZTO Hizmet Standartları',];
  ...
  BContents = ['nTicaret Sicili Rehberi', 'nOda Sicili Rehberi', 'nTicari İşletme Tanımları', 'nTicari İşlemler Rehberi', 'nKruvaziyer Turizmi', 'nHukuk Sahfası', 'tRaporlar', 'nFire ve Zaiyat Oranları', 'nGayrimenkul Danışmanlığı', 'nYenişehir Ticaret Merkezi', 'nUlusal ve Uluslararası Bağlantılar', 'nİzmir Ticaret Odası İhracatçı Firmalar Listesi', 'nİzmir', 'nSıkça Sorulan Sorular'];
  BDrop = ['tAB Raporları', 'tFuar Raporları', 'tKentsel Raporlar', 'tSektörel Raporlar', 'tDevlet Teşvikleri Dosyası', 'tÜlke Raporları' ];
